$(function () {
  $('.validateFundForm').click(function (event) {
    ...
    if (firstname == "") {
        document.getElementById('funding-status').innerHTML = "<span style='color:red'>Please enter first name</span>";
        return false;
    }
    var lastname =  document.getElementById('funding-lastname').value;
    if (lastname == "") {
        document.getElementById('funding-status').innerHTML = "<span style='color:red'>Please enter last name</span>";
        return false;
    }
    var affiliation =  document.getElementById('funding-affiliation').value;
    if (affiliation == "") {
        document.getElementById('funding-status').innerHTML = "<span style='color:red'>Please enter affiliation</span>";
        return false;
    }
    var position =  document.getElementById('funding-position').value;
    if (position == "") {
        document.getElementById('funding-status').innerHTML = "<span style='color:red'>Please enter position</span>";
        return false;
    }
    var email =  document.getElementById('funding-email').value;
    if (email == "") {
        document.getElementById('funding-status').innerHTML = "<span style='color:red'>Please enter email</span>";
        return false;
    } else {
    ...
    if (homepage == "") {
        document.getElementById('funding-status').innerHTML = "<span style='color:red'>Please enter homepage</span>";
        return false;
    }
